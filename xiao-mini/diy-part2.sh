...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='xaio_mini'' package/lean/default-settings/files/zzz-default-settings
...
#更改主机型号，支持中文。 
sed -i 's/model = "Xiaomi Mi Router 4A Gigabit Edition"/model = "小米mini"/g' target/linux/ramips/dts/mt7621_xiaomi_mi-router-4a-gigabit.dts
