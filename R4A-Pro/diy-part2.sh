...
echo "echo '<script src=\"https://cdn.jsdelivr.net/gh/YL2209/live2d-widget-mini@latest/autoload.js\"></script>' >> /usr/lib/lua/luci/view/footer.htm" >> package/lean/default-settings/files/zzz-default-settings
