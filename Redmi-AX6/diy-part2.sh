...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='RAX6'' package/lean/default-settings/files/zzz-default-settings
...
#更改主机型号，支持中文。 
sed -i 's/model = "Redmi AX6"/model = "红米 AX6"/g' target/linux/ipq807x/files/arch/arm64/boot/dts/qcom/ipq8071-ax6.dts
...
echo "sed -i '/关于/a\<tr><td width=\"33%\">天气</td><td><iframe width=\"640\" scrolling=\"no\" height=\"75\" frameborder=\"0\" allowtransparency=\"true\" src=\"https://i.tianqi.com?c=code&id=39&color=%23FF5200&icon=3&num=2&site=12\"></iframe></td></tr>' /usr/lib/lua/luci/view/admin_status/index.htm" >> package/lean/default-settings/files/zzz-default-settings
